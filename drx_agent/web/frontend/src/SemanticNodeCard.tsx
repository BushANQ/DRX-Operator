...
const kindStyles: Record<string, KindPresentation> = {
  ...
  turn: { label: '对话回合', variant: 'turn', color: '#88acd5', Icon: ChatCircle },
  task: { label: '任务', variant: 'task', color: '#b291ec', Icon: GitBranch },
  subtask: { label: '子任务', variant: 'task', color: '#b291ec', Icon: GitBranch },
  intent: { label: '探索任务', variant: 'task', color: '#b291ec', Icon: Target },
  workertask: { label: '派发任务', variant: 'task', color: '#b291ec', Icon: GitBranch },
